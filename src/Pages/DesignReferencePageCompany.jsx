...
export default function DesignReferencePageCompany() {
      ...
      <div className="h-full mt-[90px] w-full">
        <div className="min-w-fit h-[334px] bg-white shadow-lg relative mx-10 rounded-tl-[9999px] rounded-[520px]">
          <img
            ...
            alt=""
            className="w-[340px] absolute right-0 top-0"
          />
          ...
          <div className="mt-5 text-center">
            ...
            <div className="flex justify-center items-center mt-7">
              <div className="flex justify-between items-center px-14 w-[720px] h-24 rounded-[10px] shadow-lg">
                ...
                <Link
                  to="sort-reference"
                  onClick={() => handleTabClick("sort-reference")}
                  className="font-medium text-2xl"
                >
                  Reference
                  <div
                    className={` ${
                      activeTab === "sort-reference"
                ...
                <Link
                  onClick={() => handleTabClick("sort-certificate")}
                  to="sort-certificate"
                  className="font-medium text-2xl"
                >
                  Certificate
            ...
            <Link to="form-editor"
              href="#"
              className="flex justify-center mt-5 items-end text-xl underline font-medium text-green_custom"
            >
              Go to Design
              <svg
                className="ml-3"
