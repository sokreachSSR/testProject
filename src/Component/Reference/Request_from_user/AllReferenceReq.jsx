...
export default function AllReferenceReq() {
  return (
    <div>
      <div className={`${DropShadow} bg-white border-2 border-light_gray_custom mt-5  font-MainFont m-auto py-4`}>
        <p className="p-5 font-bold font-MainFont text-xl" >All Reference</p>
        <div className="">
