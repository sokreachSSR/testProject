...
export default function DetailJobV2({ data }) {
        ...
        <div className="absolute overflow-hidden2 w-full">
          <div className="overscroll-x-none px-5 py-3">
            <div className="static">
              ...
              <img
                src={`${BASE_URL1}/api/v1/images/PROFILE?fileName=${companyDetail.coverImage}`}
                ...
                Object.entries(data.requirementsAndSkill).length > 0 ? (
                  ...
                  >
                    ...
                    <ul className="list-disc">
                      {Object.entries(data.requirementsAndSkill).map((items) => (
