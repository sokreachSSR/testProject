      ...
      <div className={`${DropShadow} bg-white w-full py-4 rounded-[20px] px-5`}>
        <div className="flex justify-between items-center">
          <div className="flex justify-between ">
            ...
            <div className="ml-3 font-semibold font-SecondaryFont text-gray-700">
        ...
        <div className=" font-SecondaryFont flex justify-between mb-1 mt-3">
          <div>
            {item.postInteract.Like_count <= 1 ? (
              <span>{likeNumber[item.postId]} Like</span>
            ) : item.postInteract.Like_count >= 2 ? (
              <span>{likeNumber[item.postId]} Likes</span>
            ) : (
              ""
            )}
          </div>
            ...
            comments[item.postId].map((comment, index) => (
              <div>
                ...
                <div className=" flex justify-start items-start w-full mb-2 mt-2 group">
                  ...
                  <NavLink to="/profile">
                    <img
                      src={BASE_URL1 + comment.comments.profile_image}
                      alt=""
